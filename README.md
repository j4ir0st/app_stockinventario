...
| :--- | :--- | :--- |
| **0.8.2** | 2026-09-15 | **Visualización y Ordenamiento por Fecha de Vencimiento en Detalle (Stock_ERP)**: Se sustituyó el campo `fecha_movimiento` por `fecha_venc` en la tabla detalle de almacenaje (`Stock_ERP`). Se actualizó el encabezado a *Fecha Vencimiento* y la lógica reactiva de ordenamiento en memoria para ordenar de forma ascendente y descendente según la fecha de vencimiento del producto. |
